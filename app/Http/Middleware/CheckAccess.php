...
class CheckAccess
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $permissions = [
            '1' => ['index','show','create','store','edit','update','delete','deleteMonitoramento','storeResposta','respostas','edit-monitoramentos','update-monitoramentos','prazo','monitoramento','editMonitoramento'],
