...
class RespostaService
{
    ...
    public function insertRespostas($id, array $validatedData)
    {
        try {
            ...
            Log::error('Erro ao inserir resposta do monitoramento.', [
                'message' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
            throw new Exception('Houve um erro inesperado ao inserir uma resposta.');
        }
    }
    ...
    public function updateResposta($id, array $validatedData)
    {
        try {
            ...
            Log::error('Erro ao atualizar resposta:', [
                'message' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
            throw $e;
    ...
    public function destroyAnexo($id)
    {
        try {
            ...
            Log::error("Erro ao deletar anexo da resposta ID $id: " . $e->getMessage(), [
                'stack' => $e->getTraceAsString()
            ]);
            throw new Exception('Houve um erro ao deletar o anexo da providência.');
        }
    }
    ...
    public function homologacaoResposta($id)
    {
        try {
            ...
            Log::error('Houve um erro inesperado ao homologar a resposta', ['error' => $e->getMessage()]);
            throw new Exception('Houve um erro inesperado no processo de homologação da providência');
        }
    }
