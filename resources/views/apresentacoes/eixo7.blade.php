...
@section('content')
  ...
  @if(auth()->user()->unidade->unidadeTipoFK == 1 || auth()->user()->unidade->unidadeTipoFK == 3 || auth()->user()->unidade->unidadeTipoFK == 4)
    ...
    <div class="d-flex justify-content-center gap-2 flex-wrap mb-4">
      <a href="{{ route('relatorios.eixos', ['id' => 7]) }}" class="highlighted-btn-sm highlight-blue text-decoration-none">
      ...
      <a href="{{ route('anexo', $eixo_id ?? 7) }}" class="highlighted-btn-sm highlight-blue text-decoration-none">
    ...
    <div class="modal fade" id="modalUploadAnexo" tabindex="-1" aria-labelledby="modalUploadAnexoLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="{{ route('anexo.upload', $eixo_id ?? 7) }}" method="POST" enctype="multipart/form-data">
            @csrf
