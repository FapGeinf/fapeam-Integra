        ...
        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownStatusEixo">
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2"
              href="{{ route('atividades.executadas', ['eixo_id' => $eixo_id ?? 8]) }}">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2"
              href="{{ route('atividades.acompanhamento', ['eixo_id' => $eixo_id ?? 8]) }}">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2"
              href="{{ route('atividades.nao-executadas', ['eixo_id' => $eixo_id ?? 8]) }}">
