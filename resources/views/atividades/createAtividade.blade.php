      ...
      <form action="{{ route('atividades.store') }}" method="POST" id="formStoreAtividade">
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-4">
            ...
            <input type="number" name="ano" id="ano" class="form-control" value="{{ old('ano', date('Y')) }}"
              placeholder="Ex: 2026" min="1900" max="2100" required>
          </div>
          ...
          <div class="col-12 col-md-8">
            ...
            <select name="eixo_ids[]" id="eixo_ids" class="form-select pointer" multiple>
          ...
          <div class="col-12 col-md-6">
            ...
            <select name="tipo_evento" id="tipo_evento" class="form-select pointer">
              <option value="0" {{ old('tipo_evento') == '0' || old('tipo_evento') === null ? 'selected' : '' }}>
                Sem evento
              </option>
          ...
          <div class="col-12">
            <label for="canal_id">Canal de Divulgação:</label>
          ...
          <div class="col-12">
            ...
            <select name="status_atividade_id" id="status_atividade_id" class="form-select">
              ...
              @foreach ($statusAtividades as $statusAtividade)
                <option value="{{ $statusAtividade->id }}" {{ old('status_atividade_id') == $statusAtividade->id ? 'selected' : '' }}>
          ...
          <div class="col-12 col-md-6">
            ...
            <input type="number" name="meta" id="meta" class="form-control input-enabled" min="0"
              value="{{ old('meta') }}" oninput="mostrarUnidade()" placeholder="Ex: 0">
          </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <input type="number" name="realizado" id="realizado" class="form-control input-enabled" min="0"
              value="{{ old('realizado') }}" oninput="mostrarUnidade()" placeholder="Ex: 0">
          </div>
