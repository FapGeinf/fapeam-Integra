                ...
                <div class="card-body">
                    <form action="{{ route('atividades.store') }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="atividade_descricao" id="atividade_descricao" class="form-control" required></textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="publico_alvo" id="publico_alvo" class="form-control" required maxlength="255">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <select name="tipo_evento" id="tipo_evento" class="form-select" required>
                                ...
                                <option value="TeleConferência">TeleConferência</option>
                            </select>
                        </div>

                        <div class="mb-5">
                            <label for="canal_divulgacao" class="form-label">Canal de Divulgação:</label>
                            <input type="text" name="canal_divulgacao" id="canal_divulgacao" class="form-control" required maxlength="255">
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="date" name="data_realizada" id="data_realizada" class="form-control" min="{{ \Carbon\Carbon::today()->toDateString() }}">
                        </div>
