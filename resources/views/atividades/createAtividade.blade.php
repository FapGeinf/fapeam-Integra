            ...
            <div class="card-body">
                <form action="{{ route('atividades.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="publico_alvo" id="publico_alvo" class="form-control" required maxlength="255" value="{{ old('publico_alvo') }}">
                    </div>

                    <div class="mb-5">
                        <label for="tipo_evento" class="form-label">Tipo de Evento:</label>
                        <select name="tipo_evento" id="tipo_evento" class="form-select" required>
                            <option value="Presencial" {{ old('tipo_evento') == 'Presencial' ? 'selected' : '' }}>Presencial</option>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="canal_divulgacao" id="canal_divulgacao" class="form-control" required maxlength="255" value="{{ old('canal_divulgacao') }}">
                    </div>
