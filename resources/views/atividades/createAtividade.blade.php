    ...
    <div class="form_create border">
        ...
        <form action="{{ route('atividades.store') }}" method="POST" id="formStoreAtividade">
            ...
            <div class="row g-3">
                    ...
                    <select name="eixo_ids[]" id="eixo_ids" class="form-select" multiple>
                        ...
                        @foreach ($eixos as $eixo)
                            <option value="{{ $eixo->id }}"
                                {{ in_array($eixo->id, old('eixo_ids', [])) ? 'selected' : '' }}>
                ...
                <div class="col-12">
                    <label for="atividade_descricao" class=""><span
                    ...
                    <select name="publico_id" id="publico_id" class="form-select">
                        ...
                        @foreach ($publicos as $publico)
                            <option value="{{ $publico->id }}"
                                {{ old('publico_id') == $publico->id ? 'selected' : '' }}>
                                {{ $publico->nome }}
                            </option>
                        @endforeach
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="tipo_evento" id="tipo_evento" class="form-select">
                        <option value="0"
                            {{ old('tipo_evento') == '0' || old('tipo_evento') === null ? 'selected' : '' }}>Sem evento
                        </option>

                        <option value="1" {{ old('tipo_evento') == '1' ? 'selected' : '' }}>Presencial</option>
                        <option value="2" {{ old('tipo_evento') == '2' ? 'selected' : '' }}>Online</option>
                        <option value="2" {{ old('tipo_evento') == '3' ? 'selected' : '' }}>Presencial e Online
                        </option>
                    </select>
                </div>
                    ...
                    <select name="canal_id[]" id="canal_id" class="form-select" multiple onchange="toggleOtherField()">
                        ...
                        @foreach ($canais as $canal)
                            <option value="{{ $canal->id }}"
                                {{ in_array($canal->id, old('canal_id', [])) ? 'selected' : '' }}>
                                {{ $canal->nome }}
                            </option>
                        @endforeach
                ...
                <div class="col-12" id="novo_canal_div" style="display: none;">
                    ...
                    <input type="text" id="novo_canal" name="novo_canal" class="form-control"
                        placeholder="Digite o novo canal">
                    <button type="button" class="btn btn-primary mt-2" onclick="criarCanal()">Criar Novo
                        Canal</button>
                </div>
                ...
                <div id="modalMessage" class="modal" tabindex="-1" aria-labelledby="modalMessageLabel"
                    aria-hidden="true">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="date" name="data_realizada" id="data_realizada"
                        class="form-control input-enabled" value="{{ old('data_realizada') }}"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" name="meta" id="meta" class="form-control input-enabled"
                        min="0" value="{{ old('meta') }}" oninput="mostrarUnidade()"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="number" name="realizado" id="realizado" class="form-control input-enabled"
                        min="0" value="{{ old('realizado') }}" oninput="mostrarUnidade()"
                        placeholder="Apenas números">
                </div>

                <div class="col-12 col-md-6" id="unidade-container" style="display: none;">
                    <label for="medida_id" class=""> <span class="asteriscoTop">*</span>Tipo de
                        Unidade:</label>
