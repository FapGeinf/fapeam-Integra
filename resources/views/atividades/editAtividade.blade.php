            ...
            {{ old('objetivo', $atividade->objetivo) }}
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="tipo_evento" id="tipo_evento" class="form-select">
                            ...
                            <option value="1"
                                {{ old('tipo_evento', $atividade->tipo_evento) == '1' ? 'selected' : '' }}>Presencial
                            </option>

                            <option value="2"
                                {{ old('tipo_evento', $atividade->tipo_evento) == '2' ? 'selected' : '' }}>Online</option>

                            <option value="3"
                                {{ old('tipo_evento', $atividade->tipo_evento) == '3' ? 'selected' : '' }}>Presencial e
                                Online</option>
                        </select>
                    </div>
