                        ...
                        <tbody>
                            @foreach ($atividades as $atividade)
                                <tr>
                                    ...
                                    <td>{{ $atividade->data_realizada ? \Carbon\Carbon::parse($atividade->data_realizada)->format('d/m/Y') : 'Não realizada' }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $atividade->id }}">
                                                Excluir
                                            </button>
                                        </div>
                                    </td>
