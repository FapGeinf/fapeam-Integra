        ...
        <div class="row g-3 mt-3 align-items-end">
          ...
          <div class="col-12 col-sm-6 col-md-2">
            ...
            <div class="d-flex pb-2">
              <button type="button" class="highlighted-btn-sm highlight-blue d-flex align-items-center gap-2"
                data-bs-toggle="modal" data-bs-target="#modalRelatorioStatus">
                ...
                <tr class="text13">
                  ...
                  {{-- <td>
                    ...
                    <div class="d-flex justify-content-center gap-1">
                      <a href="{{ route('atividades.edit', $atividade->id) }}" class="warning" style="font-size: 13px;"><i
