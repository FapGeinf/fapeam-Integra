    ...
    <div class="card border-0 bg-warning bg-gradient text-dark shadow-sm mb-4 rounded-3 mt-4">
        <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            @if(isset($eixo_id) && $eixo_id)
                <div>
                    <a class="btn btn-dark btn-sm text-warning fw-bold rounded-pill shadow-sm" href="{{ route('eixo.mostrar', ['eixo_id' => $eixo_id]) }}">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                ...
                @if(Auth::user()->unidadeIdFK == 1)
                    <div>
                        <a href="{{ route('atividades.create') }}" class="btn btn-sm btn-warning text-dark fw-bold shadow-sm">
                            ...
                            <tr class="text13">
                                ...
                                <td class="text-center">
                                    <div class="small">
                                        ...
                                        <span class="fw-bold text-warning">Realiz: {{ $atividade->realizado }}</span>
