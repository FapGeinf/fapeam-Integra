      ...
      <div class="justify-content-center">
        ...
        <div class="row g-3 mt-3 align-items-end">
          ...
          <div class="col-12 col-sm-6 col-md-2">
            ...
            <div class="dropdown">
              <button class="highlighted-btn-sm highlight-blue dropdown-toggle" type="button" id="dropdownMenuButton"
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <li>
                  <button type="button" class="dropdown-item gap-1" data-bs-toggle="modal"
                    data-bs-target="#modalRelatorioStatus" style="font-size: 13px !important;">
        ...
        <div class="table-responsive pt-4">
          <div class="modal fade" id="modalRelatorioStatus" tabindex="-1" aria-labelledby="modalRelatorioStatusLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <form id="formRelatorioStatus" action="" method="GET" target="_blank"
                  data-route-url="{{ route('relatorios.atividades-status', ':id') }}">
                  <div class="modal-body text-start">
                    <p class="text-muted text13">Selecione o status desejado para gerar o arquivo PDF consolidado de todas
                      as atividades correspondentes:</p>
          ...
          <table id="tableHome2" class="table table-striped cust-datatable mb-2">
            <thead>
              <tr style="white-space: nowrap;">
                <th scope="col" style="width: 280px;" class="{{ request()->query('eixo_id') == 8 ? '' : 'd-none' }}">Eixos
                </th>
