            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Unidades') }}</label>

                            <div class="col-md-6">
                                <select name="unidadeIdFK" id="unidadeIdFK" class="form-control @error('unidadeIdFK') is-invalid @enderror">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('CPF') }}</label>
