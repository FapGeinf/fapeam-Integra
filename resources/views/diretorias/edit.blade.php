@extends('layouts.app')
@section('title') {{ 'Editar Diretoria' }} @endsection
@section('content')
...
<div class="container pt-5" style="max-width: 680px;">
  <div class="col-12 border box-shadow">
    <h5 class="text-center">Editar Diretoria</h5>
    ...
    <form action="{{ route('diretorias.update', $diretoria->id) }}" method="POST" id="formStoreDiretoria">
      @csrf
      @method('PUT')
      ...
      <div class="row g-3">
        <div class="col-12">
          ...
          <input type="text" class="form-control input-enabled" id="diretoriaSigla" name="diretoriaSigla" 
                 value="{{ $diretoria->diretoriaSigla }}" required>
        </div>
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control input-enabled" id="diretoriaNome" name="diretoriaNome" 
                 value="{{ $diretoria->diretoriaNome }}" required>
        </div>
