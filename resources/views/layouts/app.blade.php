              ...
              <ul class="d-flex justify-content-center">
                ...
                <li class="li-navbar2">
                  <a href="{{ route('documentos.intro') }}"
                    class="d-flex li-a a-navbar {{ Request::routeIs('documentos.intro') ? 'li-a-active' : '' }}">
                ...
                <li class="li-navbar2">
                  <a href="{{ route('documentos.eixos') }}"
                    class="d-flex li-a a-navbar {{ Request::routeIs('documentos.eixos') ? 'li-a-active' : '' }}">
                ...
                <li class="li-navbar2">
                  <a href="{{ route('documentos.historico') }}"
                    class="d-flex li-a a-navbar {{ Request::routeIs('historico') ? 'li-a-active' : '' }}">
                ...
                @if(in_array(Auth::user()->usuario_tipo_fk, [1, 2, 4]))
                  <li class="li-navbar2">
                    <a href="{{ route('respostas.index') }}"
                      class="d-flex li-a a-navbar {{ Request::routeIs('respostas.index') ? 'li-a-active' : '' }}">
