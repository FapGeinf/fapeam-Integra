...
<div class="form-wrapper1">
    <div class="form_create border">
        ...
        <form action="{{ route('riscos.monitoramento', ['id' => $monitoramento->id]) }}" method="post"
            ...
            <div class="row g-3">
                <div class="col-sm-12">
                    <label for="monitoramentoControleSugerido-{{ $monitoramento->id }}">Controle sugerido:</label>
            ...
            <div class="row g-3 mt-2">
                <div class="col-12 col-sm-6">
                    <label for="statusMonitoramento-{{ $monitoramento->id }}">Status:</label>
                ...
                <div class="col-12 col-sm-6">
                    <label for="isContinuo-{{ $monitoramento->id }}">É Contínuo?</label>
            ...
            <div class="row g-3">
                <div class="col-12 col-sm-6">
                    <label for="inicioMonitoramento-{{ $monitoramento->id }}">Início:</label>
                    <input type="date" class="form-control input-enabled" id="inicioMonitoramento-{{ $monitoramento->id }}"
                ...
                <div class="col-12 col-sm-6" id="fimMonitoramentoContainer">
                    <label for="fimMonitoramento-{{ $monitoramento->id }}">Fim:</label>
                    <input type="date" class="form-control input-enabled" id="fimMonitoramento-{{ $monitoramento->id }}"
...
<script>
    function showConfirmationModal() {
        let monitoramentoControleSugerido = CKEDITOR.instances['monitoramentoControleSugerido-{{ $monitoramento->id }}'].getData();
