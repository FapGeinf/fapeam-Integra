...
@section('title') {{ 'Editar Monitoramento' }} @endsection
...
<body>
    ...
    <div class="form-wrapper pt-4">
        <div class="form_create">
            ...
            <form action="{{ route('riscos.monitoramento', ['id' => $monitoramento->id]) }}" method="post" id="formEditMonitoramento">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div>
                        <button type="button" onclick="showConfirmationModal()" class="btn btn-primary btn-success">Salvar Edição</button>
                    </div>
                </div>
