    ...
    <body>
        ...
        <div class="container-fluid p-30">
            <div class="col-12 box-shadow">
                <h5 class="text-center mb-2">Monitoramentos Implementadas Parcialmente</h5>
                ...
                <div>
                    ...
                    <div class="text-center mb-4">
                        @if (Auth::user()->unidade->unidadeTipoFK == 1 && $riscosDaUnidade->isNotEmpty())
                            <a href="{{ route('riscos.edit-monitoramentos', ['id' => $riscosDaUnidade->first()->id]) }}" class="primary">Adicionar Monitoramentos</a>
                        @endif
                    </div>
                </div>
            </div>
