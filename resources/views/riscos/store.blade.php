...
<script src="{{ asset('js/riscos/storeNivelRisco.js') }}"></script>
<style>
    .error-box {
    ...
    <div class="form-wrapper pt-4 paddingLeft">
        <div class="form_create border">
            ...
            <form action="{{ route('riscos.store') }}" method="post" id="formCreate" enctype="multipart/form-data">
                ...
                <textarea id="riscoConsequencia" name="riscoConsequencia" class="textInput"
                    required>{{ old('riscoConsequencia') }}</textarea>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6 col-md-6">
                        ...
                        <input type="number" name="probabilidade" id="probabilidade" class="form-control" min="1" max="5"
                            required value="{{ old('probabilidade') }}">
                    </div>
                ...
                <div class="mt-3 text-end">
                    <input type="button" onclick="addMonitoramentos()" value="Adicionar Controle Sugerido" class="blue-btn">
