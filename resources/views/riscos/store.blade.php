            ...
            <div class="form_create border">
                ...
                <form action="{{ route('riscos.store') }}" method="post" id="formCreate" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-4 col-md-3">
                            ...
                            <input type="text" id="riscoAno" name="riscoAno" class="form-control dataValue"
                                placeholder="0000" minlength="4" maxlength="4" required value="{{ old('riscoAno') }}">
                        </div>
                        ...
                        <div class="col-sm-4 col-md-9 selectUnidade">
                            ...
                            <select name="unidadeId" id="unidadeId" class="form-control form-select" required>
                                ...
                                @foreach ($unidades as $unidade)
                                    <option value="{{ $unidade->id }}" {{ old('unidadeId') == $unidade->id ? 'selected' : '' }}>
                                        {{ $unidade->unidadeNome }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <input type="text" name="responsavelRisco" id="responsavel" class="textInput form-control"
                        placeholder="Ex: Fulano da Silva Pompeo" maxlength="100" required value="{{ old('responsavelRisco') }}">

                    <label for="riscoEvento">Evento de Risco Inerente:<span class="asterisco">*</span></label>
                    <textarea id="riscoEvento" name="riscoEvento" class="textInput" required>{{ old('riscoEvento') }}</textarea>

                    <label for="riscoCausa">Causa do Risco:<span class="asterisco">*</span></label>
                    <textarea id="riscoCausa" name="riscoCausa" class="textInput" required>{{ old('riscoCausa') }}</textarea>

                    <label for="riscoConsequencia">Consequência do Risco:<span class="asterisco">*</span></label>
                    <textarea id="riscoConsequencia" name="riscoConsequencia" class="textInput" required>{{ old('riscoConsequencia') }}</textarea>

                    <div class="row g-3">
                      
                        <div class="col-sm-6 col-md-6">
                            <label for="probabilidade">Probabilidade:<span class="asterisco">*</span></label>
                            <input type="number" name="probabilidade" id="probabilidade" class="form-control" min="1" max="5" required value="{{ old('probabilidade') }}">
                        </div>
 
                        <div class="col-sm-6 col-md-6">
                            <label for="impacto">Impacto:<span class="asterisco">*</span></label>
                            <input type="number" name="impacto" id="impacto" class="form-control" min="1" max="5" required value="{{ old('impacto') }}">
                        </div>
