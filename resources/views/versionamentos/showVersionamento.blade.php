...
<script src="{{ asset('js/versionamentos/showVersionamento.js') }}"></script>
...
<div class="d-flex align-items-center justify-content-center mt-5 mb-5">
  <div class="row justify-content-center" style="max-width: 900px;">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm border-1" style="border-bottom-left-radius: 0 !important; border-bottom-right-radius: 0 !important;">
          ...
          <ul class=" mt-3 mb-3" id="versionamentosList">
            {{-- @foreach ($versionamentos as $versionamento) --}}
              ...
              {{--<li class="ms-3">
                ...
                <li class="ms-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat recusandae assumenda debitis ab quasi in!</li>

                <li class="ms-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo a quae molestias quia deleniti pariatur laudantium aspernatur nam. Esse, illum?</li>
            {{-- @endforeach --}}
          </ul>
        </div>
      </div>
